package lcci.s16.p10livingpeoplelcci;
...
public class Solution {
    ...
    public int maxAliveYear(int[] birth, int[] death) {
        int[] diff = new int[2002];
        for (int i = 0; i < birth.length; i++) {
            diff[birth[i]]++; diff[death[i] + 1]--;
        }
    ...
    public static void main(String[] args) {
        assert new Solution().maxAliveYear(new int[]{1900, 1901, 1950}, new int[]{1948, 1951, 2000}) == 1901;
    }
