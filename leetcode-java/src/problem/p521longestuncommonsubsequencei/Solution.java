package problem.p521longestuncommonsubsequencei;
 ...
 * underlined characters in "aebdc" to get "abc".
...
public class Solution {
    ...
    public static void main(String[] args) {
        assert new Solution().findLUSlength("aaa", "aaa") == -1;
        assert new Solution().findLUSlength("aaa", "bbb") == 3;
        assert new Solution().findLUSlength("aba", "cdc") == 3;
    }
