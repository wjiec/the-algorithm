...
*/
select p.product_id, p.product_name from Sales as s join Product p on s.product_id = p.product_id
group by p.product_id, p.product_name
having max(s.sale_date) < '2019-04-01' and min(s.sale_date) >= '2019-01-01'
