package problem.p1629slowestkey;
...
public class Solution {
    ...
    public static void main(String[] args) {
        assert new Solution().slowestKey(new int[]{1,2}, "ba") == 'b';

        assert new Solution().slowestKey(new int[]{9,29,49,50}, "cbcd") == 'c';
        assert new Solution().slowestKey(new int[]{12,23,36,46,62}, "spuda") == 'a';
    }
